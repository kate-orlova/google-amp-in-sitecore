...
2. Each AMP page has its unique URL as per AMP guidelines (see https://support.google.com/webmasters/answer/6340290?hl=en), for example, an "/amp/" suffix can be added to the standard page URL;
...
Check of the current context by _Context.IsAmpRequest()_ will allow to adopt the existing components for AMP view.
